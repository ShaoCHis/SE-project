  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="courseList">
        ...
        <el-table-column label="责任教师ID" prop="teacherId"></el-table-column>
        <el-table-column label="显示详情">
          <template slot-scope="scope">
            <el-button type="primary" @click="showDialog(scope.row.courseId)">查看</el-button>
          </template>
        </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <!--                        删除按钮-->
            <el-button type="primary" @click="removeById(scope.row.courseId)"
...
export default {
  data()
  {
    return {
      ...
      addFormRules: {
        ...
        teacher: [
          {required: true, message: '请输入责任教师', trigger: 'blur'}]
      }
    };
  },
  //一开始就显示活动列表
  ...
  methods: {
    ...
    async removeById(courseId)
    {
      ...
      {
        await this.$http.post(this.$api.PrincipalDeleteOneActivityUrl + "/" + courseId);
