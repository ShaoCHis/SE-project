      ...
      <el-table :data="examineCurData">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button type="primary" @click="showStudent(scope.row.classId)"
                       icon="el-icon-edit"></el-button>
            <!--                        删除按钮-->
      ...
      <el-dialog title="创建班级" :visible.sync="addDialogVisible"
        ...
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="150px"
          ...
          <el-form-item label="教师id:" prop="teacherid">
            <el-input style="width: 82%;" v-model="this.id" :disabled="true"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    {
      let that = this;
      axios.post("//localhost:8080/classes/add?week=" + that.addForm.week + "&starttime=" + that.addForm.starttime + "&endtime=" + that.addForm.endtime + "&room=" + that.addForm.room + "&courseid=" + that.addForm.courseid+ "&teacherid=" + this.id+"&reportrate="+that.addForm.reportrate+"&attendrate="+that.addForm.attendrate+"&cprate="+0).then((res) => {
        //隐藏添加公告对话框
